    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <form action="{{ url('/post/') }}" method="post" id="formAntrian">
                        @csrf
                        ...
                        <label for="nomorhp" class="form-label">Nomor</label>
                        ...
                        <select class="form-select" name="paket">
                            ...
                            <option value="Regular" @if ($paket == 'Self-photo Regular') selected @endif>
                                Regular
                            </option>
                            <option value="Premium" @if ($paket == 'Self-photo Premium') selected @endif>
                                Premium
                            </option>
                        </select>
