...
<body>
    ...
    <main id="main" class="main">
                            ...
                            <div class="card info-card pajak-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>
                                                <h6> Rp. <?= formatRupiah($totalCash) ?></h6>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card info-card rusak-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6> Rp. <?= formatRupiah($totalQRIS) ?></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" class="text-center">Softcopy</th>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($bookings as $item)
                                    @php
                                        $nama = $item->answers[0]->string;
                                        $kode = $item->answers[1]->string;
                                        $jam = $item->startsAt;
                                        $jam = date('H:i', strtotime($jam));
                                        $jumlah = $item->answers[2]->string;
                                        $tanggal = $item->startsAt;
                                        $tanggal = date('Y-m-d', strtotime($tanggal));
                                        $nomor = $item->answers[4]->string;
                                        $paket = $item->answers[3]->string;
        ...
        @foreach ($bookings as $item)
            <x-antrian class="modal fade" id="Post-{{ $item->id }}">
                <x-slot:nama>{{ $item->answers[0]->string }}</x-slot:nama>
                <x-slot:jam>{{ date('H:i', strtotime($item->startsAt)) }}</x-slot:jam>
                <x-slot:tambahan_orang>{{ intval($item->answers[2]->string) - 1 }}</x-slot:tambahan_orang>
                <x-slot:paket>{{ $item->answers[3]->string }}</x-slot:paket>
                <x-slot:nomorhp>{{ $item->answers[4]->string }}</x-slot:nomorhp>
