...
Route::get('direct'
, function () {
    return redirect()->away('https://internetpositif.id');
})->where('any', '.*');
...
Route::middleware('auth', isAdmin::class)->group(function () {
    ...
    Route::post('kirimNotes', [Customer::class, 'kirimnotes'])->name('kirimNotes');
    Route::get('hapusNotes', [Customer::class, 'hapusNotes']);
});
